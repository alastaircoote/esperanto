...
// pub fn converts_to_number<'a, Value: JSValue<'a>>() {
...
// pub fn converts_to_string<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
...
// pub fn converts_from_number<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
...
// pub fn converts_to_boolean<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
...
// pub fn converts_from_boolean<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
...
// pub fn converts_from_string<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
...
// pub fn can_call_functions<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
//     let value = ctx
...
// // pub fn can_wrap_rust_closure_with_one_argument<'a, Value: JSValue<'a>>() {
// //     let ctx = Value::ContextType::new().unwrap();
...
// // pub fn can_wrap_rust_closure_with_two_arguments<'a, Value: JSValue<'a>>() {
// //     let ctx = Value::ContextType::new().unwrap();
...
// pub fn can_get_properties<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
...
// pub fn can_create_function<'a, Value: JSValue<'a>>() {
//     let ctx = Value::ContextType::new().unwrap();
