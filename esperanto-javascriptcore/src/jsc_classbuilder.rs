...
// impl JSClassBuilder<JSCGlobalContext> for JSCClassBuilder {
//     type Definition = JSClassDefinition;

//     fn class_prototype_from_definition(
//         definition: Self::Definition,
//         in_context: &Rc<JSCGlobalContext>,
//     ) -> Result<JSCValue, JSContextError> {
//         let class = unsafe { JSClassCreate(&definition) };
//         let js_obj = unsafe { JSObjectMake(in_context.raw_ref, class, std::ptr::null_mut()) };
//         JSCValue::from_class_ref(class, js_obj, in_context)
//     }
// }
